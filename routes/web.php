...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/performance-indicator', [PerformanceIndicatorController::class, 'index'])->name('performance-indicator.index');
    Route::get('/performance-indicator/{id}', [PerformanceIndicatorController::class, 'show'])->name('performance-indicator.show');
    Route::resource('leave-requests', EmployeeLeaveController::class);
    Route::resource('fimp', EmployeeFimpController::class)->except(['show']);
    Route::resource('overtime-requests', OvertimeRequestController::class)->except(['show']);
