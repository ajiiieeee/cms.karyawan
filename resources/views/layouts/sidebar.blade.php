<aside class="sidebar">
  ...
  <div class="sidebar-menu-area"><ul class="sidebar-menu" id="sidebar-menu">
    ...
    <li><a href="{{ route('personal-data.index') }}"><i class="ri-user-3-line"></i><span>Data Pribadi</span></a></li>
