...
@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
        ...
        <p class="text-neutral-600 mt-4 mb-0">Settings &raquo; User Management &raquo; Tambah</p>
      </div>
    </div>
    ...
    <div class="card shadow-1 radius-8">
      <div class="card-body p-24">
        <form action="{{ route('user-management.store') }}" method="POST" enctype="multipart/form-data" id="form-user">
          @csrf
          @include('user-management.partials.form', ['user' => null])
