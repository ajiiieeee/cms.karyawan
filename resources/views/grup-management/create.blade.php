...
@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
        <h6 class="fw-semibold mb-0">Tambah Grup</h6>
        <p class="text-neutral-600 mt-4 mb-0">Settings &raquo; Grup Management &raquo; Tambah</p>
      </div>
    </div>
    ...
    <div class="card shadow-1 radius-8">
      <div class="card-body p-24">
        <form action="{{ route('grup-management.store') }}" method="POST" id="form-grup">
          @csrf
          @include('grup-management.partials.form', ['grup' => null])
