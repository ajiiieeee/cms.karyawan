...
@section('title', 'Edit Penjadwalan Kursus')

@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
        <h6 class="fw-semibold mb-0">Edit Penjadwalan Kursus</h6>
        <p class="text-neutral-600 mt-4 mb-0">Penjadwalan &raquo; Edit</p>
      </div>
    </div>
    ...
    <form action="{{ route('penjadwalan.update', \App\Helpers\IdEncryptor::encrypt($penjadwalan->id)) }}" method="POST" enctype="multipart/form-data" id="form-penjadwalan">
      @csrf
      @method('PUT')
      @include('penjadwalan.partials.form', ['penjadwalan' => $penjadwalan])
