...
@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
        <h6 class="fw-semibold mb-0">Edit Menu</h6>
        <p class="text-neutral-600 mt-4 mb-0">Settings &raquo; Menu Management &raquo; Edit</p>
      </div>
    </div>
    ...
    <div class="card shadow-1 radius-8">
      <div class="card-body p-24">
        <form action="{{ route('menu-management.update', \App\Helpers\IdEncryptor::encrypt($menu->id)) }}" method="POST" id="form-menu">
          @csrf
          @method('PUT')
          @include('menu-management.partials.form', ['menu' => $menu])
