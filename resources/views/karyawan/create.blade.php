...
@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
        ...
        <p class="text-neutral-600 mt-4 mb-0">Data Master &raquo; Karyawan &raquo; Tambah</p>
      </div>
    </div>
    ...
    <form action="{{ route('karyawan.store') }}" method="POST" enctype="multipart/form-data" id="form-karyawan">
      @csrf
      @include('karyawan.partials.form', ['karyawan' => null])
