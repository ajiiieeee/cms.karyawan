...
@section('content')
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
      <div>
        <h6 class="fw-semibold mb-0">Tambah Saldo Cuti</h6>
        <p class="text-neutral-600 mt-4 mb-0">Saldo Cuti &raquo; Tambah</p>
      </div>
    </div>
    ...
    <form action="{{ route('saldo-cuti.store') }}" method="POST" id="form-saldo-cuti">
      @csrf
      @include('saldo-cuti.partials.form', ['saldoCuti' => null])
      ...
      <div class="d-flex justify-content-end gap-8 mt-24">
        ...
        <button type="submit" class="btn btn-primary-600 btn-submit">
          <span class="btn-text">Simpan Saldo Cuti</span>
...
$(document).ready(function () {
    ...
    function doOverlapCheck() {
        ...
        $.ajax({
            ...
            method: 'GET',
            data: { karyawan_id: karyawanId, periode_mulai: mulai, periode_selesai: selesai },
